...
public class HTMLEntities {
    ...
    static {
        ...
        // load entities
        load0(props, "/cyberneko/HTMLlat1.properties");
        load0(props, "/cyberneko/HTMLspecial.properties");
        load0(props, "/cyberneko/HTMLsymbol.properties");
        load0(props, "/cyberneko/XMLbuiltin.properties");
    ...
    private static void load0(final Properties props, final String filename) {
        try {
        	InputStream resourceAsStream = HTMLEntities.class.getResourceAsStream(filename);
